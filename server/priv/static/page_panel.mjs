...
var page_panel = "page-panel";

// build/dev/javascript/o11a_client/o11a/ui/page_panel.mjs
...
function view(_) {
  return div(
    toList([class$("w-[30rem]")]),
    toList([
      h2(toList([]), toList([text2("Questions")])),
      h2(toList([]), toList([text2("ToDos")])),
      h2(toList([]), toList([text2("Finding Leads")])),
      h2(toList([]), toList([text2("Confirmed Findings")]))
    ])
  );
}
function component2() {
  return component(init2, update, view, from_list(toList([])));
}
var name = page_panel;
