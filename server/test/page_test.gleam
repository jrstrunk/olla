...
pub fn style_code_tokens_operator_test() {
  page.style_code_tokens("if (hi < hello == world) {")
  |> should.equal(
...
pub fn style_code_tokens_function_definition_test() {
  page.style_code_tokens("function hello(string memory world) {")
  |> should.equal(
...
pub fn style_code_tokens_comment_test() {
  page.style_code_tokens("return vr; // hello world")
  |> should.equal(
...
pub fn style_code_tokens_contract_test() {
  page.style_code_tokens("using SafeERC20 for IERC20;")
  |> should.equal(
...
pub fn style_code_tokens_number_test() {
  page.style_code_tokens("uint256 hello = 10;")
  |> should.equal(
